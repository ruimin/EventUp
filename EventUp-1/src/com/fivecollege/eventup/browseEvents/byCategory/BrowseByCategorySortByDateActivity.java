...
public class BrowseByCategorySortByDateActivity extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		List<GregorianCalendar> dates = datasource
				.getDatesByCategory(categoryId);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(
				R.menu.activity_browse_by_category_sort_by_date, menu);
		return true;
	}
